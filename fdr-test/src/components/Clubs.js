                ...
                return ( // bruh react be like...
                    ...
                    {post_arr.map((post, i) => (
                       ...
                       <div class="card-header">
                        ...
                        <div id={"postid-"+index.toString()+":"+i.toString()} key={i}class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="gedf-drop1">
                                        ...
                                        <a class="dropdown-item" href="#"onClick={editPost}>Edit</a>
                                        <a class="dropdown-item" href="#"onClick={()=>deletePost("postid-"+post.from_club.toString()+":"+index.toString()+","+i.toString())}>Delete</a>
