...
<main class="flex-shrink-0">
    <div class="container">
        ...
        <p class="lead">Let us introduce you to Firey - application for high school students. Our aim is to give a tool for extracurricular activities in school, as well as demonstrate opportunities for students in forming and improving their vision for their future careers. Here they can share ideas with fellow students from their own school or club, forming <code class="small">challenges</code> and observing results at the end of month or week. Very helpful feature is the portfolio of a student with their accomplishments and future plans. There you can find clubs students are attending as well as the role in recent events hosted by a club. Also the application along with clubs supports sport activities, we consider this as a very prominent part of our platform.
...
(I guess we’ll add this later) Students signing up for clubs do not have to attend all the meetings, but their attendance will be seen for them only in the profile page. Any user including teachers or club leaders can observe the challenges and events hosted by their clubs or sports teams in an interactive calendar. In the main page Students will be able to observe <code class="small">opportunities</code> hosted by verified organizations according to interests of a particular student. The organizations will have to pay fixed fee in order to be on posts page for Students.</p>
        <p>please <a href="https://v5.getbootstrap.com/docs/5.0/examples/sticky-footer/">contact</a> us if you have any questions.</p>
    </div>
</main>
